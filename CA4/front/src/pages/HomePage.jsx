...
const HomePage = () => {
    ...
    return (
        <div className="bg-light">
            ...
            <br/><br/>
    <div class="p-4 rounded-3 d-flex flex-column flex-md-row align-items-center w-100 hello-box">
        <div class="container py-5 px-4">
            <div class="p-4 rounded-3 d-flex flex-column flex-md-row align-items-center w-60">
                <div class="text-center text-md-start col-md-8 px-4 ps-md-5">
                    <p class="mb-3 fs-4 ps-md-5">
                ...
                <div class="col-md-4 mt-4 mt-md-0 text-end pe-md-5">
                    <img src="/assets/shelf.svg" class="img-fluid pe-md-2" alt=""/>
                </div>
            </div>
        </div>
    </div>
